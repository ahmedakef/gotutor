...
var $author$project$Steps$Steps$Loading = {$: 'Loading'};
var $author$project$Main$Model = F3(
	function (key, url, state) {
		return {key: key, state: state, url: url};
	});
...
var $author$project$Steps$Steps$getSourceCode = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$Steps$Steps$GotSourceCode),
...
var $author$project$Steps$Decoder$Step = F3(
	function (goroutine, packageVars, stacktrace) {
		return {goroutine: goroutine, packageVars: packageVars, stacktrace: stacktrace};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Steps$Decoder$Goroutine = F3(
	function (id, currentLoc, userCurrentLoc) {
		return {currentLoc: currentLoc, id: id, userCurrentLoc: userCurrentLoc};
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Steps$Decoder$Location = F4(
	function (pc, file, line, _function) {
		return {file: file, _function: _function, line: line, pc: pc};
	});
var $author$project$Steps$Decoder$Function = F5(
	function (name, value, type_, goType, optimized) {
		return {goType: goType, name: name, optimized: optimized, type_: type_, value: value};
	});
...
var $author$project$Steps$Decoder$VariableI = function (a) {
	return {$: 'VariableI', a: a};
};
																													...
																													return A3(
																														...
																														function (declLine) {
																															return $elm$json$Json$Decode$succeed(
																																$author$project$Steps$Decoder$VariableI(
																																	{addr: addr, base: base, cap: cap, children: children, declLine: declLine, flags: flags, kind: kind, len: len, locationExpr: locationExpr, name: name, onlyAddr: onlyAddr, realType: realType, type_: type_, unreadable: unreadable, value: value}));
																														});
																												});
																										});
																								});
...
try {
	...
	throw 'Some top-level definitions from `Steps.Decoder` are causing infinite recursion:\n\n  ┌─────┐\n  │    variableDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
																	...
																	return A3(
																		...
																		function (defers) {
																			return A3(
																				...
																				function (err) {
																					return $elm$json$Json$Decode$succeed(
																						{_arguments: _arguments, defers: defers, err: err, file: file, frameOffset: frameOffset, framePointerOffset: framePointerOffset, _function: _function, line: line, locals: locals, pc: pc});
																				});
																		});
																});
														});
...
var $author$project$Steps$Steps$getSteps = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Steps$Steps$GotSteps, $author$project$Steps$Decoder$stepsDecoder),
...
var $author$project$Steps$Steps$StepsState = F4(
	function (steps, position, sourceCode, highlightedLine) {
		return {highlightedLine: highlightedLine, position: position, sourceCode: sourceCode, steps: steps};
	});
				...
				switch (msg.$) {
					...
					case 'Next':
						return (_Utils_cmp(
							...
							$elm$core$List$length(successState.steps)) > 0) ? _Utils_Tuple2(
							$author$project$Steps$Steps$Success(successState),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							$author$project$Steps$Steps$Success(
								_Utils_update(
									successState,
									{position: successState.position + 1})),
							$elm$core$Platform$Cmd$none);
					case 'Prev':
						return ((successState.position - 1) < 0) ? _Utils_Tuple2(
							$author$project$Steps$Steps$Success(successState),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							$author$project$Steps$Steps$Success(
								_Utils_update(
						...
						return _Utils_Tuple2(
							$author$project$Steps$Steps$Success(
								_Utils_update(
									successState,
									{
										highlightedLine: $elm$core$Maybe$Just(line)
									})),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(
							$author$project$Steps$Steps$Success(
								_Utils_update(
									successState,
									{highlightedLine: $elm$core$Maybe$Nothing})),
							$elm$core$Platform$Cmd$none);
				}
			case 'Failure':
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var stepsMsg = msg.a;
				var _v2 = A2($author$project$Steps$Steps$update, stepsMsg, model.state);
				var state = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Steps$Steps$Next = {$: 'Next'};
var $author$project$Steps$Steps$Prev = {$: 'Prev'};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Add = {$: 'Add'};
...
var $author$project$Steps$View$codeView = function (state) {
	var highlightedLine = A2($elm$core$Maybe$withDefault, 0, state.highlightedLine);
	var highlightModeCurrentLine = A2(
		$elm$core$Maybe$map,
		function (_v1) {
			return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Add;
		},
		state.lastStep);
	var currentLine = A2($elm$core$Maybe$withDefault, 0, state.currentLine);
	var highlightModeHighlightedLine = _Utils_eq(highlightedLine, currentLine) ? $elm$core$Maybe$Nothing : A2(
		$elm$core$Maybe$map,
		function (_v0) {
			return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Highlight;
		},
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(state.sourceCode)
									]))
							])),
					A2(
						$elm$core$Result$map,
						...
						A2(
							...
							A2(
								...
								$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$noLang(state.sourceCode))))))
			]));
};
...
var $author$project$Steps$View$goroutineView = function (maybeStep) {
	var gInfo = function () {
		if (maybeStep.$ === 'Nothing') {
			return 'Program did not start yet';
		} else {
			var step = maybeStep.a;
			return (step.goroutine.id === 1) ? 'Main Goroutine' : ('Goroutine: ' + $elm$core$String$fromInt(step.goroutine.id));
		}
	}();
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
...
var $author$project$Steps$View$varView = function (v) {
	...
	var children = A2($elm$core$String$startsWith, '[]', _var.type_) ? A2(
		$elm$core$List$indexedMap,
		F2(
			function (i, child) {
				var vI = child.a;
				return $author$project$Steps$Decoder$VariableI(
					_Utils_update(
						vI,
						{
							name: '[' + ($elm$core$String$fromInt(i) + (']' + vI.name))
						}));
			}),
		_var.children) : A2(
		...
		function (child) {
			...
			return A2(
				...
				A2(
					...
					$elm$core$String$uncons(vI.name)));
		},
		_var.children);
	return A2(
		$rtfeldman$elm_css$Html$Styled$li,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								$author$project$Steps$View$removeMainPrefix(_var.name) + ' = '),
								A2(
								...
								_List_fromArray(
									[
										...
										'{' + (_var.type_ + (' | ' + (A3(
											...
											0,
											8,
											$author$project$Helpers$Hex$intToHex(_var.addr)) + '}  '))))
									])),
	...
	var fileName = A2(
		...
		$elm$core$List$head(
			$elm$core$List$reverse(
				A2($elm$core$String$split, '/', frame.file))));
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				$author$project$Steps$Steps$Highlight(frame.line)),
				$rtfeldman$elm_css$Html$Styled$Events$onMouseLeave(
				$author$project$Steps$Steps$Unhighlight(frame.line))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								$author$project$Steps$View$removeMainPrefix(frame._function.name))
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$text(
						fileName + (':' + $elm$core$String$fromInt(frame.line)))
					])),
				A3(
				...
				A3($author$project$Steps$View$varsView, 'locals:', frame.locals, _List_Nil)
			]));
};
...
var $author$project$Steps$View$programVisualizer = function (state) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Steps$View$goroutineView(state.lastStep),
				A3(
				$author$project$Steps$View$varsView,
				'Global Variables:',
				$elm$core$Maybe$Just(state.packageVars),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
				...
				$author$project$Steps$View$stackView(state.stack)
			]));
};
var $author$project$Steps$View$VisualizeState = F6(
	function (lastStep, stack, packageVars, sourceCode, currentLine, highlightedLine) {
		return {currentLine: currentLine, highlightedLine: highlightedLine, lastStep: lastStep, packageVars: packageVars, sourceCode: sourceCode, stack: stack};
	});
...
var $author$project$Steps$View$filterUserFrames = function (stack) {
	return A2(
		$elm$core$List$filter,
		function (frame) {
			return A2($elm$core$String$endsWith, 'main.go', frame.file);
		},
		stack);
};
var $author$project$Steps$View$stateToVisualize = function (stepsState) {
	var stepsSoFar = A2($elm$core$List$take, stepsState.position, stepsState.steps);
	var lastStep = $elm$core$List$head(
		$elm$core$List$reverse(stepsSoFar));
	if (lastStep.$ === 'Just') {
		var step = lastStep.a;
		var packageVars = step.packageVars;
		var callHierarchy = $author$project$Steps$View$filterUserFrames(step.stacktrace);
		var currentLine = A2(
			$elm$core$Maybe$map,
			function ($) {
				return $.line;
		...
		return {
			...
			lastStep: $elm$core$Maybe$Just(step),
			packageVars: packageVars,
			sourceCode: stepsState.sourceCode,
			stack: callHierarchy
		};
	} else {
		return A6($author$project$Steps$View$VisualizeState, lastStep, _List_Nil, _List_Nil, stepsState.sourceCode, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing);
	}
};
										...
										_List_fromArray(
											[
																...
																_List_fromArray(
																	[
																		...
																		$elm$core$String$fromInt(
																			$elm$core$List$length(stepsState.steps))),
																		$rtfeldman$elm_css$Html$Styled$Attributes$value(
																		$elm$core$String$fromInt(stepsState.position)),
												...
												_List_fromArray(
													[
														$rtfeldman$elm_css$Html$Styled$text(
														'Step ' + ($elm$core$String$fromInt(stepsState.position) + (' of ' + $elm$core$String$fromInt(
															$elm$core$List$length(stepsState.steps)))))
													]))
											]))
									])),
	...
	var body = A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Steps$View$view(model.state)),
