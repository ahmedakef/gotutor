...
{
	if (region.bv.bm === region.bU.bm)
	{
		return 'on line ' + region.bv.bm;
	}
	return 'on lines ' + region.bv.bm + ' through ' + region.bU.bm;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dA, request.cT, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {b3: fragment, b9: host, cq: path, cs: port_, cw: protocol, cx: query};
	});
...
var $author$project$Steps$Steps$Loading = {$: 2};
var $author$project$Main$Model = F3(
	function (key, url, state) {
		return {cj: key, a7: state, cT: url};
	});
var $author$project$Main$StepsMsg = function (a) {
	return {$: 2, a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Steps$Steps$GotSourceCode = function (a) {
	return {$: 1, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{c1: false, c6: r.c6, bY: r.bY, b6: r.b6, dA: r.dA, dZ: r.dZ, cO: r.cO, cT: r.cT}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{c6: $elm$http$Http$emptyBody, bY: r.bY, b6: _List_Nil, dA: 'GET', dZ: $elm$core$Maybe$Nothing, cO: $elm$core$Maybe$Nothing, cT: r.cT});
};
var $author$project$Steps$Steps$getSourceCode = $elm$http$Http$get(
	{
		bY: $elm$http$Http$expectString($author$project$Steps$Steps$GotSourceCode),
		cT: '/example/main.txt'
	});
var $author$project$Steps$Steps$GotSteps = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Steps$Decoder$Step = F3(
	function (goroutine, packageVars, stacktrace) {
		return {dn: goroutine, dJ: packageVars, dT: stacktrace};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Steps$Decoder$Goroutine = F3(
	function (id, currentLoc, userCurrentLoc) {
		return {dc: currentLoc, dq: id, d2: userCurrentLoc};
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Steps$Decoder$Location = F4(
	function (pc, file, line, _function) {
		return {bg: file, bj: _function, bm: line, br: pc};
	});
var $author$project$Steps$Decoder$Function = F5(
	function (name, value, type_, goType, optimized) {
		return {dm: goType, cm: name, dI: optimized, cS: type_, cU: value};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Steps$Decoder$functionDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Steps$Decoder$Function,
	...
	A2($elm$json$Json$Decode$field, 'goType', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'optimized', $elm$json$Json$Decode$bool));
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Steps$Decoder$locationDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Steps$Decoder$Location,
	...
	A2($elm$json$Json$Decode$field, 'function', $author$project$Steps$Decoder$functionDecoder));
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Steps$Decoder$goroutineDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Steps$Decoder$Goroutine,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'currentLoc', $author$project$Steps$Decoder$locationDecoder),
	A2($elm$json$Json$Decode$field, 'userCurrentLoc', $author$project$Steps$Decoder$locationDecoder));
...
var $author$project$Steps$Decoder$VariableI = $elm$core$Basics$identity;
function $author$project$Steps$Decoder$cyclic$variableDecoder() {
	return A3(
																		...
																		function (len) {
																			return A3(
																				...
																				$elm$json$Json$Decode$list(
																					$author$project$Steps$Decoder$cyclic$variableDecoder()),
																				function (children) {
																					return A3(
																						$webbhuset$elm_json_decode$Json$Decode$Field$require,
																						'cap',
																													...
																													return A3(
																														...
																														function (declLine) {
																															return $elm$json$Json$Decode$succeed(
																																{c$: addr, c5: base, c7: cap, da: children, de: declLine, dk: flags, dw: kind, dx: len, dy: locationExpr, cm: name, dG: onlyAddr, dL: realType, cS: type_, d$: unreadable, cU: value});
																														});
																												});
																										});
																								});
...
var $author$project$Steps$Decoder$variableDecoder = $author$project$Steps$Decoder$cyclic$variableDecoder();
$author$project$Steps$Decoder$cyclic$variableDecoder = function () {
	return $author$project$Steps$Decoder$variableDecoder;
};
var $author$project$Steps$Decoder$stacktraceDecoder = $elm$json$Json$Decode$list(
	A3(
		$webbhuset$elm_json_decode$Json$Decode$Field$require,
		'pc',
		$elm$json$Json$Decode$int,
					...
					return A3(
						...
						function (line) {
							return A3(
								$webbhuset$elm_json_decode$Json$Decode$Field$require,
								'function',
								$author$project$Steps$Decoder$functionDecoder,
								function (_function) {
									return A3(
										$webbhuset$elm_json_decode$Json$Decode$Field$require,
										'Locals',
										$elm$json$Json$Decode$maybe(
											$elm$json$Json$Decode$list($author$project$Steps$Decoder$variableDecoder)),
										function (locals) {
											return A3(
												$webbhuset$elm_json_decode$Json$Decode$Field$require,
												'Arguments',
																	...
																	return A3(
																		...
																		function (defers) {
																			return A3(
																				...
																				function (err) {
																					return $elm$json$Json$Decode$succeed(
																						{bF: _arguments, bS: defers, bV: err, bg: file, b4: frameOffset, b5: framePointerOffset, bj: _function, bm: line, ck: locals, br: pc});
																				});
																		});
																});
														});
...
var $author$project$Steps$Decoder$stepDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Steps$Decoder$Step,
	A2($elm$json$Json$Decode$field, 'Goroutine', $author$project$Steps$Decoder$goroutineDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'PackageVariables',
		$elm$json$Json$Decode$list($author$project$Steps$Decoder$variableDecoder)),
	A2($elm$json$Json$Decode$field, 'Stacktrace', $author$project$Steps$Decoder$stacktraceDecoder));
var $author$project$Steps$Decoder$stepsDecoder = $elm$json$Json$Decode$list($author$project$Steps$Decoder$stepDecoder);
var $author$project$Steps$Steps$getSteps = $elm$http$Http$get(
	{
		bY: A2($elm$http$Http$expectJson, $author$project$Steps$Steps$GotSteps, $author$project$Steps$Decoder$stepsDecoder),
		cT: '/example/steps.json'
	});
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var initialModel = A3($author$project$Main$Model, key, url, $author$project$Steps$Steps$Loading);
		var getSteps = A2($elm$core$Platform$Cmd$map, $author$project$Main$StepsMsg, $author$project$Steps$Steps$getSteps);
		var getSourceCode = A2($elm$core$Platform$Cmd$map, $author$project$Main$StepsMsg, $author$project$Steps$Steps$getSourceCode);
		var combinedCmd = $elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[getSteps, getSourceCode]));
		return _Utils_Tuple2(initialModel, combinedCmd);
	});
...
var $author$project$Steps$Steps$Failure = function (a) {
	return {$: 1, a: a};
};
var $author$project$Steps$Steps$StepsState = F4(
	function (steps, position, sourceCode, highlightedLine) {
		return {bk: highlightedLine, K: position, cJ: sourceCode, bw: steps};
	});
var $author$project$Steps$Steps$Success = function (a) {
	return {$: 0, a: a};
};
var $author$project$Helpers$Http$errorToString = function (error) {
	switch (error.$) {
		case 0:
			var url = error.a;
...
var $author$project$Steps$Steps$update = F2(
	function (msg, state) {
		switch (state.$) {
			case 0:
				var successState = state.a;
				switch (msg.$) {
					case 0:
						var gotStepsResult = msg.a;
						if (!gotStepsResult.$) {
							var steps = gotStepsResult.a;
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Success(
									_Utils_update(
										successState,
										{bw: steps})),
								$elm$core$Platform$Cmd$none);
						} else {
							var err = gotStepsResult.a;
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Failure(
									$author$project$Helpers$Http$errorToString(err)),
								$elm$core$Platform$Cmd$none);
						}
					case 1:
						var sourceCodeResult = msg.a;
						if (!sourceCodeResult.$) {
							var sourceCode = sourceCodeResult.a;
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Success(
									_Utils_update(
										successState,
					...
					case 2:
						return (_Utils_cmp(
							successState.K + 1,
							$elm$core$List$length(successState.bw)) > 0) ? _Utils_Tuple2(
							$author$project$Steps$Steps$Success(successState),
							...
							$elm$core$Platform$Cmd$none);
					case 3:
						return ((successState.K - 1) < 0) ? _Utils_Tuple2(
							$author$project$Steps$Steps$Success(successState),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							$author$project$Steps$Steps$Success(
								_Utils_update(
				...
				switch (msg.$) {
					case 0:
						...
						if (!gotStepsResult.$) {
							...
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Success(
									A4($author$project$Steps$Steps$StepsState, steps, 0, '', $elm$core$Maybe$Nothing)),
								$author$project$Steps$Steps$getSourceCode);
						} else {
							var err = gotStepsResult.a;
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Failure(
					...
					case 1:
						...
						if (!sourceCodeResult.$) {
							...
							return _Utils_Tuple2(
								$author$project$Steps$Steps$Success(
									A4($author$project$Steps$Steps$StepsState, _List_Nil, 0, sourceCode, $elm$core$Maybe$Nothing)),
								$elm$core$Platform$Cmd$none);
						} else {
							var err = sourceCodeResult.a;
							return _Utils_Tuple2(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var stepsMsg = msg.a;
				var _v2 = A2($author$project$Steps$Steps$update, stepsMsg, model.a7);
				var state = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{a7: state}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$StepsMsg, cmd));
		}
	});
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.df) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cm, record.df, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.bO;
	var imports = _v0.ca;
	var namespaces = _v0.cn;
	var declarations = _v0.dg;
	return {
		bO: charset,
		dg: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		ca: imports,
		cn: namespaces
	};
};
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {_: charsProcessed, ae: hash, T: seed, an: shift};
	});
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {_: data._ + 1, ae: res, T: data.T, an: data.an + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bO: charset, dg: declarations, ca: imports, cn: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bO: $elm$core$Maybe$Nothing, ca: _List_Nil, cn: _List_Nil, cI: snippets};
};
...
var $author$project$Main$inlineCss = function (inlineRawCss) {
	return A3(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(inlineRawCss)
			]));
};
...
var $author$project$Styles$flexCenter = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$horizontalUL = function (items) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$author$project$Styles$horizontalUlStyle]))
			]),
		A2(
			$elm$core$List$map,
			function (item) {
				return A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Styles$horizontalLiStyle]))
						]),
					_List_fromArray(
						[item]));
			},
...
var $rtfeldman$elm_css$Css$solid = {q: 0, U: 0, cU: 'solid'};
...
var $author$project$Styles$navItems = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$viewLink = F3(
	function (content, link, targetPage) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href(link),
					$rtfeldman$elm_css$Html$Styled$Attributes$target(targetPage),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Styles$navItems]))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$navigation = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Styles$flexCenter,
					A3(
	...
	_List_fromArray(
		[
			$author$project$Main$horizontalUL(
			_List_fromArray(
				[
					A3($author$project$Main$viewLink, 'About', '#about', '_self'),
...
var $author$project$Main$pageFooter = A2(
	...
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$id('about'),
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					A3(
	...
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text('Gotutor is a trial to show program execution steps.'),
			A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
			$rtfeldman$elm_css$Html$Styled$text('It\'s very welcomed to help by contributing to the project.'),
			A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
			$rtfeldman$elm_css$Html$Styled$text('the project only shows the main Goroutine now as descriped in '),
			A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/ahmedakef/gotutor?tab=readme-ov-file#limitations'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none)
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Limitations')
				])),
			$rtfeldman$elm_css$Html$Styled$text('.'),
			A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
			$rtfeldman$elm_css$Html$Styled$text('copyright © 2024 by '),
			A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href('https://www.linkedin.com/in/ahmedakef4/'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none)
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Ahmed Akef')
				])),
			$rtfeldman$elm_css$Html$Styled$text('.')
		]));
var $author$project$Styles$requiredShStyles = '\npre.elmsh {\n    padding: 5px;\n    margin: 0;\n    text-align: left;\n    overflow: auto;\n    // my styles\n    background-color: #f5f5f5;\n    border: 1px solid #ddd;\n    border-radius: 5px;\n\n\n}\ncode.elmsh {\n    padding: 0;\n    // my styles\n    font-family: "Courier New", Courier, monospace;\n    font-size: 14px;\n    font-family: "Courier New", Courier, monospace;\n    overflow-x: auto;\n    color: #333;\n\n}\n.elmsh-line:before {\n    content: attr(data-elmsh-lc);\n    display: inline-block;\n    text-align: right;\n    width: 20px;\n    padding: 0 20px 0 0;\n    opacity: 0.3;\n}\n.elmsh-add {\n    background-color: #b3e0b3;\n    }\n.elmsh-hl {\n    background-color:#dce5ef;\n    }\n    ';
...
var $author$project$Steps$Steps$Next = {$: 2};
var $author$project$Steps$Steps$Prev = {$: 3};
var $author$project$Steps$Steps$SliderChange = function (a) {
	return {$: 4, a: a};
};
var $rtfeldman$elm_css$Html$Styled$button = $rtfeldman$elm_css$Html$Styled$node('button');
var $rtfeldman$elm_css$Css$border3 = $rtfeldman$elm_css$Css$prop3('border');
var $author$project$Steps$View$buttonStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$backgroundColor(
			$rtfeldman$elm_css$Css$hex('f2f0ec')),
			A3(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Add = 1;
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Highlight = 0;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$highlightLines = F4(
	function (maybeHighlight, start, end, _v0) {
		...
		return A4($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$highlightLines, maybeHighlight_, start, end, lines);
	});
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bP: col, ct: problem, cE: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.cE, p.bP, p.ct);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bP: 1, f: _List_Nil, g: 1, b: 0, cE: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$newLine = function (fragments) {
	return {dl: fragments, af: $elm$core$Maybe$Nothing};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toFragment = F2(
	function (toStyle, _v0) {
		...
		switch (syntax.$) {
			case 0:
				return {c_: '', dN: 0, dY: text};
			case 1:
				return {c_: '', dN: 1, dY: text};
			case 2:
				return {c_: '', dN: 0, dY: text};
			default:
				var c = syntax.a;
				...
				return {c_: additionalClass, dN: requiredStyle, dY: text};
		}
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bP: col, db: contextStack, ct: problem, cE: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cE, s.bP, x, s.f));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{bP: 1, f: s.f, g: s.g, b: s.b + 1, cE: s.cE + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bP: s.bP + 1, f: s.f, g: s.g, b: newOffset, cE: s.cE, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.cE, s.bP, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bP: newCol, f: s.f, g: s.g, b: newOffset, cE: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bP: col, f: s0.f, g: s0.g, b: offset, cE: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.cE, s.bP, s);
	};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$fragmentView = function (_v0) {
	var text = _v0.dY;
	var requiredStyle = _v0.dN;
	var additionalClass = _v0.c_;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$lineView = F3(
	function (start, index, _v0) {
		var fragments = _v0.dl;
		var highlight = _v0.af;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Steps$View$codeView = function (state) {
	var highlightedLine = A2($elm$core$Maybe$withDefault, 0, state.bk);
	var highlightModeCurrentLine = A2(
		$elm$core$Maybe$map,
		function (_v1) {
			return 1;
		},
		state.a$);
	var currentLine = A2($elm$core$Maybe$withDefault, 0, state.bf);
	var highlightModeHighlightedLine = _Utils_eq(highlightedLine, currentLine) ? $elm$core$Maybe$Nothing : A2(
		$elm$core$Maybe$map,
		function (_v0) {
			return 0;
		},
			...
			[
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Result$map,
							A3($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$highlightLines, highlightModeCurrentLine, currentLine - 1, currentLine),
							A2(
								$elm$core$Result$map,
								A3($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$highlightLines, highlightModeHighlightedLine, highlightedLine - 1, highlightedLine),
								$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$noLang(state.cJ))))))
			]));
};
...
var $rtfeldman$elm_css$Css$num = function (val) {
	return {
		...
		as: '',
		aU: 0,
		cU: $elm$core$String$fromFloat(val)
	};
};
var $author$project$Styles$flexColumn = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Steps$View$goroutineView = function (maybeStep) {
	var gInfo = function () {
		if (maybeStep.$ === 1) {
			return 'Program did not start yet';
		} else {
			var step = maybeStep.a;
			return (step.dn.dq === 1) ? 'Main Goroutine' : ('Goroutine: ' + $elm$core$String$fromInt(step.dn.dq));
		}
	}();
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(gInfo)
					]))
			]));
};
...
var $rtfeldman$elm_css$Css$inlineBlock = {j: 0, cU: 'inline-block'};
var $author$project$Steps$View$arrow = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A3(
			$rtfeldman$elm_css$Css$border3,
			$rtfeldman$elm_css$Css$px(0),
			$rtfeldman$elm_css$Css$solid,
			$rtfeldman$elm_css$Css$hex('979494')),
			A4(
...
var $author$project$Steps$Steps$Highlight = function (a) {
	return {$: 5, a: a};
};
var $author$project$Steps$Steps$Unhighlight = function (a) {
	return {$: 6, a: a};
};
var $author$project$Steps$View$borderStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A3(
			$rtfeldman$elm_css$Css$border3,
...
var $author$project$Steps$View$removeMainPrefix = function (str) {
	var prefix = 'main.';
	var prefixLength = $elm$core$String$length(prefix);
	return A2($elm$core$String$startsWith, prefix, str) ? A2($elm$core$String$dropLeft, prefixLength, str) : str;
};
...
var $author$project$Helpers$Hex$intToHex = function (n) {
	var bigN = $cmditch$elm_bigint$BigInt$fromInt(n);
	return (n < 0) ? ('-0x' + $cmditch$elm_bigint$BigInt$toHexString(bigN)) : ('0x' + $cmditch$elm_bigint$BigInt$toHexString(bigN));
};
var $rtfeldman$elm_css$Css$listStyle = $rtfeldman$elm_css$Css$prop1('list-style');
var $rtfeldman$elm_css$Html$Styled$span = $rtfeldman$elm_css$Html$Styled$node('span');
var $author$project$Steps$View$varView = function (v) {
	var _var = v;
	var value = function () {
		var _v4 = _var.cS;
		if (_v4 === 'string') {
	...
	var children = A2($elm$core$String$startsWith, '[]', _var.cS) ? A2(
		$elm$core$List$indexedMap,
		F2(
			function (i, child) {
				var vI = child;
				return _Utils_update(
					vI,
					{
						cm: '[' + ($elm$core$String$fromInt(i) + (']' + vI.cm))
					});
			}),
		_var.da) : A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$core$List$isEmpty(children) ? $rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								$author$project$Steps$View$removeMainPrefix(_var.cm) + ' = '),
								A2(
								...
								_List_fromArray(
									[
										...
										'{' + (_var.cS + (' | ' + (A3(
											...
											0,
											8,
											$author$project$Helpers$Hex$intToHex(_var.c$)) + '}  '))))
									])),
						...
						A2($elm$core$List$map, $author$project$Steps$View$varView, children))
					]))
			]));
};
var $author$project$Steps$View$varsView = F3(
	function (title, maybeVars, attributes) {
		if (maybeVars.$ === 1) {
			return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
		} else {
			var vars = maybeVars.a;
			return $elm$core$List$isEmpty(vars) ? A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil) : A2(
				$rtfeldman$elm_css$Html$Styled$details,
				A2(
					$elm$core$List$cons,
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$map, $author$project$Steps$View$varView, vars))
					]));
		}
	});
var $author$project$Steps$View$frameView = function (frame) {
	var fileName = A2(
		$elm$core$Maybe$withDefault,
		frame.bg,
		$elm$core$List$head(
			$elm$core$List$reverse(
				A2($elm$core$String$split, '/', frame.bg))));
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Steps$View$borderStyle,
						$rtfeldman$elm_css$Css$backgroundColor(
						$rtfeldman$elm_css$Css$hex('f2f0ec'))
					])),
				$rtfeldman$elm_css$Html$Styled$Events$onMouseEnter(
				$author$project$Steps$Steps$Highlight(frame.bm)),
				$rtfeldman$elm_css$Html$Styled$Events$onMouseLeave(
				$author$project$Steps$Steps$Unhighlight(frame.bm))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$rtfeldman$elm_css$Css$displayFlex, $author$project$Styles$flexCenter]))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								$author$project$Steps$View$removeMainPrefix(frame.bj.cm))
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Loc: ')
							])),
						$rtfeldman$elm_css$Html$Styled$text(
						fileName + (':' + $elm$core$String$fromInt(frame.bm)))
					])),
				A3(
				$author$project$Steps$View$varsView,
				'arguments:',
				frame.bF,
				_List_fromArray(
					[
				...
				A3($author$project$Steps$View$varsView, 'locals:', frame.ck, _List_Nil)
			]));
};
...
var $author$project$Steps$View$up = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$transform(
			$rtfeldman$elm_css$Css$rotate(
				$rtfeldman$elm_css$Css$deg(-135)))
		]));
var $author$project$Steps$View$stackView = function (stack) {
	return $elm$core$List$isEmpty(stack) ? A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil) : A2(
		$rtfeldman$elm_css$Html$Styled$details,
		_List_fromArray(
			[
				A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'open', '')
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Stacktrace:')
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$ul,
				...
				A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Steps$View$arrow,
																	$author$project$Steps$View$up,
					...
					A2($elm$core$List$map, $author$project$Steps$View$frameView, stack)))
			]));
};
var $rtfeldman$elm_css$Css$width = $rtfeldman$elm_css$Css$prop1('width');
var $author$project$Steps$View$programVisualizer = function (state) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Steps$View$goroutineView(state.a$),
				A3(
				$author$project$Steps$View$varsView,
				'Global Variables:',
				$elm$core$Maybe$Just(state.dJ),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
				...
				$author$project$Steps$View$stackView(state.bu)
			]));
};
var $author$project$Steps$View$VisualizeState = F6(
	function (lastStep, stack, packageVars, sourceCode, currentLine, highlightedLine) {
		return {bf: currentLine, bk: highlightedLine, a$: lastStep, dJ: packageVars, cJ: sourceCode, bu: stack};
	});
var $elm$core$String$endsWith = _String_endsWith;
var $author$project$Steps$View$filterUserFrames = function (stack) {
	return A2(
		$elm$core$List$filter,
		function (frame) {
			return A2($elm$core$String$endsWith, 'main.go', frame.bg);
		},
		stack);
};
var $author$project$Steps$View$stateToVisualize = function (stepsState) {
	var stepsSoFar = A2($elm$core$List$take, stepsState.K, stepsState.bw);
	var lastStep = $elm$core$List$head(
		$elm$core$List$reverse(stepsSoFar));
	if (!lastStep.$) {
		var step = lastStep.a;
		var packageVars = step.dJ;
		var callHierarchy = $author$project$Steps$View$filterUserFrames(step.dT);
		var currentLine = A2(
			$elm$core$Maybe$map,
			function ($) {
				return $.bm;
			},
			$elm$core$List$head(callHierarchy));
		return {
			bf: currentLine,
			bk: stepsState.bk,
			a$: $elm$core$Maybe$Just(step),
			dJ: packageVars,
			cJ: stepsState.cJ,
			bu: callHierarchy
		};
	} else {
		return A6($author$project$Steps$View$VisualizeState, lastStep, _List_Nil, _List_Nil, stepsState.cJ, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing);
	}
};
var $rtfeldman$elm_css$Html$Styled$Attributes$type_ = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('type');
var $rtfeldman$elm_css$Html$Styled$Attributes$value = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('value');
var $author$project$Steps$View$view = function (state) {
	switch (state.$) {
		case 0:
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('Visualize your Go Program:')
											]))
									]))
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[$rtfeldman$elm_css$Css$displayFlex, $author$project$Styles$flexColumn, $author$project$Styles$flexCenter]))
									]),
								_List_fromArray(
									[
										$author$project$Steps$View$codeView(visualizeState),
										A2(
										$rtfeldman$elm_css$Html$Styled$div,
										_List_fromArray(
											[
											...
											[
												...
												_List_fromArray(
													[
																...
																_List_fromArray(
																	[
																		...
																		$elm$core$String$fromInt(
																			$elm$core$List$length(stepsState.bw))),
																		$rtfeldman$elm_css$Html$Styled$Attributes$value(
																		$elm$core$String$fromInt(stepsState.K)),
																		...
																		A2(
																			...
																			A2(
																				...
																				$author$project$Steps$Steps$SliderChange)))
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Steps$Steps$Prev),
																$rtfeldman$elm_css$Html$Styled$Attributes$css(
																_List_fromArray(
																	[
																		$author$project$Steps$View$buttonStyle,
																		$rtfeldman$elm_css$Css$marginRight(
																		$rtfeldman$elm_css$Css$px(10))
																	]))
															]),
														...
														_List_fromArray(
															[
																$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Steps$Steps$Next),
																$rtfeldman$elm_css$Html$Styled$Attributes$css(
																_List_fromArray(
																	[
																		$author$project$Steps$View$buttonStyle,
												...
												_List_fromArray(
													[
														$rtfeldman$elm_css$Html$Styled$text(
														'Step ' + ($elm$core$String$fromInt(stepsState.K) + (' of ' + $elm$core$String$fromInt(
															$elm$core$List$length(stepsState.bw)))))
													]))
											]))
									])),
								...
								_List_fromArray(
									[
										$author$project$Steps$View$programVisualizer(visualizeState)
									]))
							]))
					]));
		case 1:
	...
	var body = A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$inlineCss($author$project$Styles$requiredShStyles),
				$author$project$Main$navigation,
				A2(
				$rtfeldman$elm_css$Html$Styled$map,
				$author$project$Main$StepsMsg,
				$author$project$Steps$View$view(model.a7)),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dt: $author$project$Main$init, dE: $author$project$Main$UrlChanged, dF: $author$project$Main$LinkClicked, dX: $author$project$Main$subscriptions, d0: $author$project$Main$update, d3: $author$project$Main$view});
