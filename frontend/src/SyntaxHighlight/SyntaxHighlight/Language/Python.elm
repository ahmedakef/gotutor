module SyntaxHighlight.SyntaxHighlight.Language.Python exposing
    ( Syntax(..)
    , syntaxToStyle
...
import SyntaxHighlight.SyntaxHighlight.Language.Helpers exposing (Delimiter, addThen, chompIfThenWhile, consThen, delimited, isEscapable, isLineBreak, isSpace, isWhitespace, thenChompWhile)
