module SyntaxHighlight.SyntaxHighlight.Language.Xml exposing
    ( Syntax(..)
    , syntaxToStyle
...
import SyntaxHighlight.SyntaxHighlight.Language.Helpers exposing (Delimiter, addThen, chompIfThenWhile, consThen, delimited, isLineBreak, isSpace, isWhitespace, thenChompWhile)
