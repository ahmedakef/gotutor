module SyntaxHighlight.SyntaxHighlight.Language.Elm exposing
    ( Syntax(..)
    , syntaxToStyle
...
import SyntaxHighlight.SyntaxHighlight.Language.Helpers exposing (Delimiter, chompIfThenWhile, delimited, escapable, isEscapable, isLineBreak, isSpace, isWhitespace, number, thenChompWhile)
