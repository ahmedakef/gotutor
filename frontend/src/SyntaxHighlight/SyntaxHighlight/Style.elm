module SyntaxHighlight.SyntaxHighlight.Style exposing (Color(..), Required(..), RequiredStyles, Style, backgroundColor, bold, colorToCss, emptyIfFalse, italic, noEmphasis, styleToCss, textColor, toCss, toCssClass)
