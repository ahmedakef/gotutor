module SyntaxHighlight.SyntaxHighlight.Theme.OneDark exposing (css, theme)

import SyntaxHighlight.SyntaxHighlight.Style exposing (Color(..), RequiredStyles, backgroundColor, italic, noEmphasis, textColor)
import SyntaxHighlight.SyntaxHighlight.Theme.Type exposing (Theme, toCss)
