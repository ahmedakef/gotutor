module SyntaxHighlight.SyntaxHighlight.Theme.Monokai exposing (css, theme)

import SyntaxHighlight.SyntaxHighlight.Language.Css as Css
import SyntaxHighlight.SyntaxHighlight.Language.Elm as Elm
import SyntaxHighlight.SyntaxHighlight.Language.Javascript as JS
import SyntaxHighlight.SyntaxHighlight.Style exposing (Color(..), RequiredStyles, backgroundColor, bold, italic, noEmphasis, textColor)
import SyntaxHighlight.SyntaxHighlight.Theme.Type as Type exposing (Syntax(..), Theme, toCss)
