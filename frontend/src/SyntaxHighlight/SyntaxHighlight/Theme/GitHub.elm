module SyntaxHighlight.SyntaxHighlight.Theme.GitHub exposing (css, theme)

import SyntaxHighlight.SyntaxHighlight.Style exposing (Color(..), RequiredStyles, backgroundColor, noEmphasis, textColor)
